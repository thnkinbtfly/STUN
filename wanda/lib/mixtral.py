...
def get_opt(model):
    ...
    model = MixtralForCausalLM.from_pretrained(model, torch_dtype='auto')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model', type=str, default='../Mixtral-8x7B-v0.1',
    ...
    parser.add_argument(
        '--prunen', type=int, default=2,
        help='N for N:M pruning.'
    )
    parser.add_argument(
        '--prunem', type=int, default=4,
    ...
    parser.add_argument(
        '--prune_only', type=str, default='block_sparse_moe.experts',
    ...
    parser.add_argument(
       '--save', type=str, default='semi_structure_2to4_mixtral_again',
